...
$test = !("$rech" == "Musique" || "$rech" == "Multimédia" || "$rech" == "Santé" || "$rech" == "Electroménager" || "$rech" == "Décoration" || "$rech" == "Bricolage" || "$rech" == "Animaux");
...
$reqFilter = 'WHERE category = :search AND saleStatus = 0';
...
echo '<h2 class="recherche">Résultat pour la catégorie : "' . htmlspecialchars($_GET['search']) . '"</h2>';
